...
<hr>
<div style="float:left;">
	<label><?php echo __( "Post Types" )?></label><div class="clear h10"></div>
	<?php 
		$args = array(
		   'public'   => true,
		);
		...
		foreach ($posts as $post) {
			...
			echo '<input '.$selected.' type="checkbox" name="wpst_allowable_post_type[]" value="'.$post->name.'" id="wpst_pt_'.$i.'"><label for="wpst_pt_'.$i.'">'.$post->name.'</label><br />';
			$i++;
		}
